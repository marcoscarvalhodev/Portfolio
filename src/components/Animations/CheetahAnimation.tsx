...
export function CheetahAnimation(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, animations } = useGLTF('/cheetah-opt-v1.glb') as GLTFResult;
  ...
  CrossFade({ crossFadeState, crossFadeRef, texture1, texture2, dispTexture });
  PauseOutFocus({
    mixer,
    setCrossFadeState,
    time1: 16,
      ...
      <group ref={group} {...props} dispose={null}>
        <group name='Scene'>
          <group name='cheetah-rig-main'>
            ...
            >
              <meshStandardMaterial ref={crossFadeRef} toneMapped />
            </skinnedMesh>
