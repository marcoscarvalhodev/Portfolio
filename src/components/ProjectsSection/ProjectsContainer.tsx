      ...
      <div className={`${styles.videoAlternate} flex-[1] relative h-[100%]`}>
        ...
        >
          ...
          ref={refNumberBackground}
            className={`${styles.numberBackground} bg-[#033980e8] block absolute bottom-0 top-0 left-0 right-0 z-[-1]`}
          ></span>
          {id}
        </h2>
        ...
        <a
          href={link}
          target='_blank'
          className=' scale-90 hover:scale-100 text-[#0a1524] hover:text-[#fcfeff] hover:bg-[#033980de] transition-all duration-[0.6s] text-title-font-40 absolute -translate-x-[50%] -translate-y-[50%] left-[50%] top-[50%] bg-[#c59c06e3] rounded-[50%] py-[4rem] px-[3.2rem] '
        >
          View
        </a>
      </div>
      ...
      <div className={`${styles.flexText} flex flex-col flex-[1] relative`}>
        <div className={`${styles.textContent} `}>
          ...
          <div className='p-[2rem]'>
            <h1 className='text-title-font-20 md:text-title-font-50'>
              {title}
            </h1>
            <p className='text-title-font-30 md:text-title-font-50'>{text}</p>
          </div>
        </div>
      </div>
    </div>
